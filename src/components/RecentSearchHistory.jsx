const RecentSearchHistory = ({recentHistory, setRecentHistory, setSelectedHistory}) => {
          ...
          {recentHistory &&
            recentHistory.map((item, id) => (
              <li
                ...
                key={id}
                className="p-1 pl-4 truncate dark:text-zinc-400 text-zinc-700 cursor-pointer dark:hover:bg-zinc-700 hover:bg-red-200 dark:hover:text-zinc-200 hover:text-zinc-400 "
              >
                {item}
              </li> 
            ))}
